...
void FadeTexture::Init()
{
	...
	vertex[2].Position = XMFLOAT3(0.0f, 760.0f, 0.0f);
	vertex[2].Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
	vertex[2].Diffuse = XMFLOAT4(1.0f, 1.0f, 1.0f, m_fade);
	vertex[2].TexCoord = XMFLOAT2(0.0f, 1.0f);

	vertex[3].Position = XMFLOAT3(1280.0f, 760.0f, 0.0f);
	...
	ScratchImage image;
	LoadFromWICFile(L"asset\\Texture\\white.png", WIC_FLAGS_NONE, &metadata, image);
